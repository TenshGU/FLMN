...
# 边节点的数量
parser.add_argument('-ne', '--num_of_edge', type=int, default=10, help='numer of the edges')
# 边节点中智能协同设备群的最多个数
parser.add_argument('-ncoord', '--num_of_coordination', type=int, default=3, help='numer of the coordinations in each edge')
# 边节点中智能协同设备群中设备的最多个数（但大于等于3）
...
parser.add_argument('-nc', '--num_of_clients_edge', type=int, default=100, help='numer of the clients')
# 客户端离线崩溃因子
parser.add_argument('-ofl', '--off_line_factor', type=int, default=10, help='the one client in n machines will be off_line,n bigger than 5')
# 随机挑选的客户端的数量
...
if __name__ == "__main__":
    ...
    #选择GPU还是CPU
    os.environ['CUDA_VISIBLE_DEVICES'] = args['gpu'] #设置系统信息
